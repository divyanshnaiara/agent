...
class ApiSettings(BaseSettings):
    ...
    def set_cors_origin_list(cls, cors_origin_list, info: FieldValidationInfo):
        ...
        valid_cors.extend(["http://0.0.0.0:8000", "http://127.0.0.1:8000", "*", "https://phidata.app", "https://www.phidata.app"])

        runtime_env = info.data.get("runtime_env")
        if runtime_env == "dev":
            valid_cors.extend(["*", "http://localhost:8000", "http://127.0.0.1:8000", "http://localhost:3000"])
